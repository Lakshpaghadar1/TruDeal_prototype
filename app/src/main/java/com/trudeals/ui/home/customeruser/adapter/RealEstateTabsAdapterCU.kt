...
class RealEstateTabsAdapterCU :
    AdvanceRecycleViewAdapter<RealEstateTabsAdapterCU.ViewHolder, RealEstateTabCU>() {

    inner class ViewHolder(val binding: ItemRealEstateTabsRowBinding) :
        BaseHolder<RealEstateTabCU>(binding.root) {
        override fun bind(item: RealEstateTabCU) = with(binding) {

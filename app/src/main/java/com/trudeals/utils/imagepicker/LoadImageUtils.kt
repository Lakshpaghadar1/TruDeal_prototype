...
/*fun AppCompatImageView.loadUrlIcon(url: String, isCenterCrop: Boolean = true) {
    ...
    circularProgressDrawable.setColorSchemeColors(resources.getColor(R.color.colorPrimary, null)
...
fun AppCompatImageView.loadBitmap(bitmap: Bitmap) {
    ...
    val multiTransformation = MultiTransformation(
        CenterCrop(),
        RoundedCorners(context.resources.getDimension(R.dimen._6sdp).toInt())
    )
